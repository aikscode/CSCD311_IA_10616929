<?php
    if(isset($_SESSION['username'])){
        ...
        try{
            ...
            $sql = "SELECT * FROM tbl_student_data WHERE id=:search_id";
            ...
            if(isset($_POST['submit'])){
                if($idrequired || $snrequired || $fnrequired || $grequired || $pnrequired || $dobrequired || $erequired || $prrequired || $rrequired || $endrequired || $exdrequired){
                    ...
                    $sql = "INSERT INTO tbl_student_data(id, surname, firstname, othername, gender, phonenum, dob, email, campus, pic, programme, residency, entrydate, exitdate, height, weight) VALUES ('$id', '$surname', '$firstname', '$othername', '$gender', '$phonenum', '$dob', '$email', '$campus', '$pic', '$programme', '$residency', '$entrydate', '$exitdate', '$height', '$weight')";
                    $conn->exec($sql);
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="form-group">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        ...
                        <input value="<?php echo escape($result["height"]); ?>" type="number" name="height" class="form-control">
                    </div>

                    <div class="col">
                        <label for="weight"><b>Weight:&nbsp;</b><span class="red"><?php echo $wrequired;?></span></label>
                        <input value="<?php echo escape($result["weight"]); ?>" type="number" name="weight" class="form-control">
                    </div>
                </div><br/>
